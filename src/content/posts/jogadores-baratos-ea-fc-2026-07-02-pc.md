...
title: "Alemaes baratos no EA FC em 02/07 — PC"
draft: false
featured: false
tags:
  - baratos
  ...
  - budget
  - pc
description: "Em 02/07/2026 no PC, Florian Wirtz liderou a seleção de Alemaes por 2.000 coins. Compare 11 cartas, OVR, preço, 7d e gráfico."
---

<!-- historical-review:v1 -->
> **Arquivo histórico — 02/07/2026, PC:** os preços e previsões deste artigo preservam o snapshot original e não representam a cotação atual.

## Leitura do recorte

Entre 11 opções, **Florian Wirtz** tinha o menor preço (2.000 coins). O maior OVR era de **Florian Wirtz** (89), por 2.000 coins.

O preço mediano do recorte foi **12.000 coins** e 3 cartas vinham de queda em 7d. Todas estavam estritamente abaixo de 15.000 coins. OVR é só um filtro inicial; função, atributos, PlayStyles e química precisam ser conferidos antes de montar o time.

![Gráfico de preço em coins para os destaques de Alemaes baratos no EA FC em 02/07 — PC](/charts/jogadores-baratos-ea-fc-2026-07-02-pc.svg)
...
- **Rudi Völler (89, ST)** da Bundesliga, a apenas **13k coins** — vem **caindo na semana**, era uma opção relativamente barata naquele recorte.

- **Jürgen Kohler (89, CB)** da Bundesliga, a apenas **14k coins** — vem **caindo na semana**, era uma opção relativamente barata naquele recorte.
...
*Preços de PC, referência de 02/07/2026. Variações de mercado mudam a qualquer momento — invista com responsabilidade.*
