...
pubDatetime: 2026-06-02T01:31:02.000Z
title: "Momentum de Alemaes no EA FC em 01/06 — PS"
draft: false
featured: true
tags:
  - investimentos
  ...
  - previsoes
  - ps
description: "Ranking histórico de momentum em 01/06/2026 no PS: Selina Cerci liderou 7d com +79,6%. Compare preços, 24h/7d, gráfico e limites."
---
...
**Selina Cerci** liderou o recorte com **+79,6% em 7d** e +27,6% em 24h. Entre 15 cartas, 15 tinham as duas janelas positivas; a mediana semanal foi **+25,7%**.

Os preços destacados iam de **17.000 coins** a **195k coins**. O ranking descreve momentum observado naquela data; previsão ausente ou inválida aparece como N/D e não confirma uma compra atual.

![Gráfico de variação em 7 dias para os destaques de Momentum de Alemaes no EA FC em 01/06 — PS](/charts/melhores-investimentos-ea-fc-2026-06-01-ps.svg)
...
> 🔝 **Destaque:** Selina Cerci (87) acumula **+79.6% em 7 dias** a 24k coins.
...
| --- | --- | --- | --- | --- | --- | --- |
| Selina Cerci | 87 | GPFBL | 24k coins | +27.6% | +79.6% | 95% |
| Joshua Kimmich | 89 | Bundesliga | 140k coins | +25% | +55.6% | 27% |
| Larissa Mühlhaus | 85 | GPFBL | 27k coins | +11.5% | +50.7% | 95% |
...
| Toni Kroos | 90 | Icons | 96k coins | +13.7% | +25.7% | 18% |
| Matthias Ginter | 88 | Bundesliga | 29k coins | +1.8% | +24.7% | 95% |
| Marina Hegering | 87 | GPFBL | 22k coins | +12.7% | +21.9% | 27% |
...
- **Selina Cerci (87)** — 24k coins, **+79.6% em 7 dias** (+27.6% em 24h). Preço +23% acima da média de 7 dias (aquecida). 🔮 O modelo reforça a tese: **95% de chance de seguir subindo**.
...
- **Larissa Mühlhaus (85)** — 27k coins, **+50.7% em 7 dias** (+11.5% em 24h). Preço +21% acima da média de 7 dias (aquecida). O dado registrava momentum positivo; uma entrada atual exige nova validação.
...
- **Nick Woltemade (90)** — 195k coins, **+32.6% em 7 dias** (+25% em 24h). Preço +21% acima da média de 7 dias (aquecida). ⚠️ Porém o modelo já vê risco de correção no curtíssimo prazo — entre com cautela.
...
- [Alemaes baratos no EA FC em 01/06 — PS](/posts/jogadores-baratos-ea-fc-2026-06-01-ps/)
- [Alemaes no EA FC em 01/06: altas e baixas — PS](/posts/mercado-ea-fc-2026-06-01-ps/)
...
Selina Cerci (87, GPFBL) lidera, com +79.6% em 7 dias a 24k coins no Console (PS). No recorte, isso descrevia momentum observado, não uma recomendação atual.
